        ...
        <div class="container">
            <div class="grid h-full m-auto align-items-center">
                <div class="col-12 md:col-6 xl:col-4">
                    <RouterLink to = "/topics/vocabs" style="text-decoration: none; color: inherit;">
                        <Button class="p-4 w-full border-round-xl flex justify-content-between bg-black-alpha-90 hover:bg-teal-700 border-none">

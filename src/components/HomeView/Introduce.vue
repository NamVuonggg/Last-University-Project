...
<template>
            ...
            <div class="border-round-3xl flex gap-7 thesis-have">
                <div class="flex flex-column gap-4">
                    ...
                    <div class="flex gap-5"> 
                        ...
                        <img src="https://img.indiafilings.com/learn/wp-content/uploads/2015/07/12011038/starting-a-business-in-India-for-foreign-company-1024x683.jpg" class="border-round-xl m-auto" width="50%" alt="">
                    </div>
                </div>
        ...
        <div class="card p-7 shadow-4 border-round-3xl flex flex-column">
            ...
            <span class="my-6 text-2xl"><span class="text-red-500 font-italic">Thesis Assistant</span> is designed in a very friendly way that you can jump right in and get used to it.</span>
        </div>
